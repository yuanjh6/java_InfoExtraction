...
import infoextra.beta3.HtmlUnitTool;
...
//		 }
		...
		String html=HtmlUnitTool.getPageAsXml(url);
		Document doc=Jsoup.parse(html);
		doc.absUrl("http://list.lufax.com");
...
//		System.out.println(webpageInfo(html, attrMap));
	...
	public static List<Map<String, String>> itemsInfo(String html,String charset,String baseUrl,
			String eleSelect, Map<String, String> attrMap) {
